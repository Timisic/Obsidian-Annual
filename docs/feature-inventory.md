...
| Review Board | Core | Used to confirm, rename, merge, ignore, or archive candidates. |
...
| User confirmation state | Core | Users decide what is confirmed, ignored, archived, or moved into actions. |
...
| Optional AI enrichment | Support | Hidden behind explicit provider setup and context preview; cannot replace review or confirmation. |
...
| --- | --- | --- |
| Share cards | Backlog | Outside the local evidence and confirmation loop. |
...
| Chart beautification | Backlog | Visual polish should wait until evidence and confirmation are stable. |
...
| Absolute note-value wording | Remove | Replace user-facing text with review candidates, recommendation rationale, and manual confirmation language. |
