...
| Build, release, and deploy scripts | Support | Kept for maintainers; deploy requires an explicit target vault, and private validation vault deployment is not a public main-path command. |
