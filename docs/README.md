...
当前 MVP 的 canonical scope 以 [Feature Inventory](feature-inventory.md) 的 Core/Support/Backlog/Remove 分类为准。README 面向普通用户上手，SPEC 说明目标行为和验证要求；如果三者表述不一致，先按 Feature Inventory 收敛主路径，再更新 README 和 SPEC。
