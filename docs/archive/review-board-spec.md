...
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `To review (3)`<br>`Writing Systems · 2 evidence notes`<br>`Local-first tools · 3 evidence notes`<br><br>`Confirmed (1)`<br>`AI judgment · confirmed` | `Writing Systems`<br>Why proposed: Appears in notes across several months.<br><br>Connection explanation: Connects daily reflections to project notes.<br><br>Evidence:<br>`Review Fixtures/2026-01-01.md` - representative note<br>`Projects/Research.md` - backlink evidence<br><br>Review caution: confirm or rename before it enters the report.<br><br>Decisions:<br>`Accept` `Rename` `Merge` `Ignore` `Open Source Note` |
