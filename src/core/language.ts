...
export const UI_TEXT = {
  en: {
    ...
    openDashboardCommand: "Open dashboard",
    ...
    progressAiSummary: "Synthesizing themes and high-value note reasons",
  ...
  zh: {
    ...
    progressAiSummary: "提炼主题和高价值笔记理由",
